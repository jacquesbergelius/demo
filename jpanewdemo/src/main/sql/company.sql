...
CREATE TABLE EMPLOYEE (
    ...
    age INT NOT NULL,                   -- special field added to demo
...
-- Put data onto it
INSERT INTO EMPLOYEE (first_name, last_name, age, email, salary) VALUES
    ('John', 'Doe', 24, 'johndoe@somemail.com', 1000.00),
    ('Mary', 'Smith', 28, 'msmith@goodmail.com', 2000.00),
    ('Peter', 'Jones', 39,'peterjones@greatmail.com', 3000.00);
